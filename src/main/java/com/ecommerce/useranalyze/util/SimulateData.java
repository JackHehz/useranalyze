...
public class SimulateData {
	 ...
	 * @param sqlContext
	 */
	public static void simulation(JavaSparkContext sc,
			SQLContext sqlContext) {
		List<Row> rows = new ArrayList<Row>();
		
		String[] searchKeywords = new String[] {"火锅", "蛋糕", "重庆辣子鸡", "禄鼎记",
				"海底捞", "新辣道鱼火锅", "国贸大厦", "太古商场", "日本料理", "温泉"};
		String date = DateUtils.getTodayDate();
		System.out.println("eclipse的时间：  "+date);
